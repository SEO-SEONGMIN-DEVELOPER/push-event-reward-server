...
public class DlqController {
    ...
    public ResponseEntity<Map<String, Object>> retryDeadLetterMessage(
        ...
        try {
            String originalTopic = "quiz_submission";
    ...
    public ResponseEntity<Map<String, Object>> getDlqInfo() {
        ...
        info.put("dlqTopic", "quiz_submission_dlq");
        info.put("consumerGroup", "push-quiz-dlq-group");
        info.put("description", "재시도 3회 실패한 퀴즈 응모 요청이 저장됩니다");
